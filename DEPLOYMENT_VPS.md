...
| **Hostinger** | KVM 1 | 1 | 4 GB | 50 GB NVMe | 1 TB | **~£4/mo** (intro) | UK (London) |
...
> long upfront term (**12–24 months**), then **renew ~20–40% higher** (Hostinger KVM 1 renews
> around **~£7/mo**). KVM 1 is 1 vCPU / 4 GB with a lower 1 TB transfer cap — fine for this
> low‑traffic site — but plan for the renewal rate and the lock‑in.
