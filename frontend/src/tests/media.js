 ...
 * ScrollTrigger, no pinning, no fixed journey layer, and every element
 * rendered in its final state. That makes assertions about the DOM
 * deterministic instead of racing a tween.
 *
